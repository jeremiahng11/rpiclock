...
class FlowField:
    ...
    def draw(self, screen, t):
        ...
        floating_clock(screen, self.fb, self.fr)
...
class Aquarium:
    ...
    def draw(self, screen, t):
        ...
        floating_clock(screen, self.fb, self.fr, 90)
...
class Plasma:
    ...
    def draw(self, screen, t):
        ...
        floating_clock(screen, self.fb, self.fr, 80)
...
SCENES = [FlowField, MatrixRain, Aquarium, Plasma, Fractal, WordClock, FlipClock, WorldISS, WeatherRadar]
